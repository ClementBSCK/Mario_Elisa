...
export class zone_1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.ennemy1= this.ennemis.create(200, 2800, 'ennemi').setScale(0.07);
        ...
        this.ennemy2= this.ennemis.create(400, 2800, 'ennemi').setScale(0.07);
    ...
    update() {
        ...
        if (this.ennemy1) {
            if (this.ennemy1.x <810) {
              this.ennemy1.setVelocityX(80);
              this.ennemy1.anims.play('ennemi_right', true);
            } 
            else if (this.ennemy1.x > 1200) {
              this.ennemy1.setVelocityX(-80);
